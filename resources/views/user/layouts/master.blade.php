                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline me-5">
                                ...
                                <ul class="dropdown-menu my-3">
                                  <li><a class="dropdown-item my-3 " href="{{route('user#accountChangePage')}}"><i class="fa-solid fa-user me-2"></i> Account</a></li>
                                  <li><a class="dropdown-item my-3" href="{{route('user#changePasswordPage')}}"><i class="fa-solid fa-key me-2"></i>Change Password</a></li>
                                  <li>
