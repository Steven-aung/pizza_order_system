                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('product#create') }}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" value="{{old('pizzaWaitingTime')}}" name="pizzaWaitingTime" class="form-control @error('pizzaWaitingTime') is-invalid @enderror" placeholder="Enter Waiting Time....">
