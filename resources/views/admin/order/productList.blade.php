        ...
        <div class="container-fluid">
            <div class="col-md-12">
                <div class="table-responsive table-responsive-data2">
                    <a class="text-dark text-decoration-none" href="{{route('admin#orderList')}}"><i class="fa-solid fa-arrow-left-long text-dark me-2"></i>Back</a>
                    <div class="row col-5">
                        <div class="card mt-4">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col"><i class="fa-solid fa-money-bill-wave me-3"></i> Total Price</div>
